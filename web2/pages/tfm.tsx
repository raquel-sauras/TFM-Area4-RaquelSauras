...
const ClassifyImage: NextPage = () => {
    const [image, setImage] = useState<Blob | undefined>(undefined);
    const [result, setResult] = useState<Result|undefined>(undefined);

    const uploadToClient = (event: ChangeEvent | FormEvent) => {
                ...
                <div className='bg-success-light row text-primary-dark py-5 justify-content-center'>
                    <div className='col-10 col-md-8 col-lg-6 d-flex flex-wrap justify-content-center'>
                        <div className="container">
                            ...
                            <hr />
                            <div>
                                <Image src={ "http://localhost:8080/" + result.image_path } className="img-rounded" width="400" height="200" />
                            </div>
                        </div>
                    </div>
                </div>
